...
class Observacion extends CI_Model {
    ...
    function actualizarObservacion($nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, $modulo, $nom_campo, $val_campo, $observacion){
    	...
    	//1. El valor del campo es cero y se encontr� una observacion en la B.D 
    	...
    	if ((($val_campo==0)&&($id!=0))||(($obsBD!="")&&($observacion==""))){
    		...
    		//1. Si se encontr� la observaci�n, y como no viene vac�a, debo actualizarla.
    		if ($id!=0){
	    		...
	    		//2. No se encontr� la observacion, y tampoco viene vac�a, debo insertarla.   		
	    		if ($observacion!=""){
    ...
    //Obtiene el nombre del critico que le est� realizando la cr�tica a un formulario
    ...
    //Obtiene el nombre del logistico que le est� realizando la cr�tica a un formulario

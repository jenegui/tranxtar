...
<tr>
  ...
  <?php if (($inalo["err1"])||($inalo["err2"])){  ?>
  		...
  		<td align="center"><a href="javascript:justificarFicha(60);">Justificar</a></td>
  <?php } 
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td>
...
<tr class="row2">
  <td align="left"> Ingresos por servicios de restaurante y catering para eventos</td>
  ...
  <?php if (($inali["err1"])||($inali["err2"])){  ?>
  		<td align="center"><a href="javascript:corregirFicha(3,'inali');" class="redText">Corregir</a></td>
  		<td align="center"><a href="javascript:justificarFicha(61);">Justificar</a></td>
  <?php } 
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td>
...
<tr>
  <td align="left">Ingresos por servicios de bar (bebidas alcohólicas y cigarrilos), no incluidos en el valor de la tarifa de alojamiento</td>
  ...
  <?php if (($inoe["err1"])||($inoe["err2"])){  ?>
  		<td align="center"><a href="javascript:corregirFicha(3,'inba');" class="redText">Corregir</a></td>
  		<td align="center"><a href="javascript:justificarFicha(62);">Justificar</a></td>
  <?php } 
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td>
...
<tr class="row2">
  ...
  <?php if (($intio["err1"])||($intio["err2"])){ ?>
  		...
  		<td align="center"><a href="javascript:justificarFicha(63);">Justificar</a></td>
  <?php }
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td> 
...
<tr>
  ...
  <?php if (($pottot["err1"])||($pottot["err2"])){ ?>
  		...
  		<td align="center"><a href="javascript:justificarFicha(64);">Justificar</a></td>
  <?php }
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td> 
...
<tr tr class="row2">
  ...
  <?php if (($icva["err1"])||($icva["err2"])){ ?>
  		<td align="center"><a href="javascript:corregirFicha(4,'icva');">Corregir</a></td>
  		<td align="center"><a href="javascript:justificarFicha(65);">Justificar</a></td>
  <?php }
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td> 
...
<tr>
  ...
  <?php if (($ihoa["err1"])||($ihoa["err2"])){ ?>
  		<td align="center"><a href="javascript:corregirFicha(4,'ihoa');">Corregir</a></td>
  		<td align="center"><a href="javascript:justificarFicha(66);">Justificar</a></td>
  <?php }
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td> 
...
<tr>
  ...
  <?php if (($huetot["err1"])||($huetot["err2"])){ ?>
  		<td align="center"><a href="javascript:corregirFicha(4,'huetot');">Corregir</a></td>
  		<td align="center"><a href="javascript:justificarFicha(67);">Justificar</a></td>
  <?php }
        else{ ?>
        <td align="center">&nbsp;</td>
  		<td align="center">&nbsp;</td> 
...
if($intio["actual"]>$intio["anterior"] && $pottot["actual"]<$pottot["anterior"]){
	...
	<tr>
		...
		<td align="center"><a href="javascript:corregirFicha(2,'pottot');" class="redText">Corregir</a></td>
	  	<td align="center"><a href="javascript:justificarFicha(68);">Justificar</a></td>
	</tr>
	</table>
<?php
}
...
?>
	...
	<tr>
		<td align="left" style="color: red" width="80%">Justifique porque se presenta aumento en los ingresos totales y disminuci&oacute;n en el personal ocupado.</td>
		<td align="center"><a href="javascript:corregirFicha(2,'pottot');" class="redText">Corregir</a></td>
	  	<td align="center"><a href="javascript:justificarFicha(69);">Justificar</a></td>
	</tr>
	</table>
<?php
}
if($intio["actual"]<$intio["anterior"] && $pottot["actual"]>$pottot["anterior"]){
	...
	<tr>
		...
		<td align="center"><a href="javascript:corregirFicha(2,'pottot');" class="redText">Corregir</a></td>
	  	<td align="center"><a href="javascript:justificarFicha(70);">Justificar</a></td>
	</tr>
	</table>
<?php
}
...
?>
	...
	<tr>
		<td align="left" style="color: red" width="80%">Justifique porque se presenta aumento en el personal ocupado y disminución en los ingresos.</td>
		<td align="center"><a href="javascript:corregirFicha(2,'pottot');" class="redText">Corregir</a></td>
	  	<td align="center"><a href="javascript:justificarFicha(71);">Justificar</a></td>
	</tr>
	</table>
<?php
}

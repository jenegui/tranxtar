...
<form id="frmPazYSalvo" name="frmPazySalvo" method="post" action="<?php echo site_url("tematica/generarPazySalvo"); ?>">
<table width="100%" style="border: 1px solid #CCCCCC;">
<tr>
 <td><img src="<?php echo base_url("images/logo.png");?>"></td>
 <td><h1>Encuesta Mensual de Alojamiento (EMA)</h1></td>
</tr>
<tr>
...
<tr>
  ...
  <tr>
    <td align="justify">RINDI&Oacute; LA ENCUESTA MENSUAL DE ALOJAMIENTO CORRESPONDIENTE AL PERIODO <b><?php echo strtoupper($pyz["periodo"]); ?></b> Y CUMPLI&Oacute; CON LOS REQUISITOS ESTABLECIDOS EN LA LEY 0079 DEL 20 DE OCTUBRE DE 1993, POR
        LO CUAL HA SIDO INSCRITA EN SUS ARCHIVOS EN LA ACTIVIDAD DE SERVICIOS CIIU REV4. EL ESTABLECIMIENTO DEBER&Aacute; IDENTIFICARSE CON EL N&Uacute;MERO: <?php echo $pyz["nro_establecimiento"]; ?> PARA TODOS LOS TR&Aacute;MITES

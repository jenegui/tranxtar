...
class Modulo3 extends CI_Model {
    ...
    function obtenerModulo($nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo) {
        $modulo3 = array();
        $sql = "SELECT C.modulo3, IO.inalo, IO.inalovd, IO.inaloatc, IO.inali, IO.inba, IO.insr, IO.inoeconv, IO.inoeeven, IO.inoe, IO.inoio, IO.intio
        ...
        if ($query->num_rows() > 0) {
            foreach ($query->result() as $row) {
                ...
                $modulo3["inoeconv"] = $row->inoeconv;
                $modulo3["inoeeven"] = $row->inoeeven;
    ...
    function actualizarModulo($inalo, $inalovd, $inaloatc, $inali, $inba, $insr,  $inoeconv, $inoeeven, $inoe, $inoio, $intio, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo) {
    ...
    function insertarModulo($inalo, $inalovd, $inaloatc, $inali, $inba, $insr, $inoeconv, $inoeeven, $inoe, $inoio, $intio, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo) {
        $data = array('inalo' => $inalo,
            'inalovd' => $inalovd,
            'inaloatc' => $inaloatc,
            'inali' => $inali,

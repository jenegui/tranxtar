...
<td>
	<table width="100%">
	<tr>
	  <td><label style="display: block; float: left; width: 750px;">Nombre comercial del establecimiento:&nbsp;&nbsp;&nbsp;<input type="text" id="idnomcomest" name="idnomcomest" value="" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?> /></label>

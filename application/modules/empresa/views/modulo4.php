...
<table width="100%">
  ...
  <tr>
    ...
    <td>
    	<table>
	    	<tr>
	    		<td>a). Ocupadas por venta directa</td>
		    </tr>
		    <tr>
  ...
  <tr>
	...
	<td>
		<table>
			<tr>	
				<td>b). Ocupadas por tiempo compartido<td/>
			</tr>
			<tr>	
  	...
  	<td rowspan="2"><input type="text" id="ihoa" name="ihoa" value="<?php echo $modulo4["ihoa"]; ?>" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></td>
...
<table width="100%">
  ...
  <tr>
    ...
    <th width="" style="padding-right: 20px; text-align:center">Tarifa promedio por persona<br> (valor en pesos)</th>			  
  </tr>
  </thead>
  <tbody>
  <tr>
...
<table width="100%">
  ...
  <tr>
    <td><label>5. Amercos (imprevistos incluye transito.) </label></td>
  ...
  <tr>
    <td><label><span id="textoMICE">6. Otros no solicitados antes (Especificque en observaciones)</span></label></td>

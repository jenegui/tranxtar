    ...
    public function descargaPlanosXLS($modulo) {
        ...
        switch ($modulo) {
            case 1: //Descarga de planos en excel para el modulo I
                $nomfile = "modulo1.xls";
                $headers = array("ano_periodo","mes_periodo","nro_orden","nro_establecimiento","ulocal","idnit","iddv","idproraz","idact","iddirecc","iddepto","nom_depto","idmpio","nom_mpio","idtelno","idpagweb","idcorreo",
                                     "idnomcomest","iddireccest","iddeptoest","nom_deptoest","idmpioest","nom_mpioest","idtelnoest","idcorreoest","nom_cadena","nom_operador","fk_novedad","fk_sede","nom_sede","fk_subsede","nom_subsede","fk_estado","estado");
            ...
            case 3: //Modulo III
                $nomfile = "modulo3.xls";
                $headers = array("nro_orden", "nro_establecimiento", "ano_periodo", "mes_periodo", "idact", "inalo", "inali", "inba", "insr", "inoeconv", "inoeeven", "inoe", "inoio", "intio", "fk_novedad", "fk_estado", "estado");
                $data = $this->modulo3->descargaPlanosModulo($ano_periodo, $mes_periodo);
                break;

            case 4: //Modulo IV
                $nomfile = "modulo4.xls";
                $headers = array("nro_orden", "nro_establecimiento", "ano_periodo", "mes_periodo", "idact", "habdia", "ihdo", "ihoavd", "ihoatc", "ihoa", "camdia", "icda", "icva", "ihpnvd", "ihpntc", "ihpn", "ihpnrvd", "ihpnrtc", "ihpnr", "huetot", "mvor", "mvsr", "mvnr", "mvcr", "mvam", "mvotr", "mvott", "mvonr", "mvsnr", "mvnnr", "mvcnr", 
                    "mvamnr", "mvotnr", "mvottnr", "thsen", "thusen", "thdob", "thudob",  "ingsen", "ingdob", "ingtot", "tphto", "inalosen", "inalodob", "inalotot", "fk_novedad", "fk_estado", "estado");
            ...
            case 7: //Descarga consolidado modulo II
                ...
                $headers = array("nro_orden", "nro_establecimientos", "ano_periodo", "mes_periodo", "potpsfr", "potperm", "gpper", "pottcde", "gpssde", "pottcag", "gpppta", "potpau", "gppgpa", "pottot", "gpsspot", "tipo_encuesta");
            ...
            case 8: //Descarga consolidado modulo III
                ...
                $headers = array("nro_orden", "nro_establecimientos", "ano_periodo", "mes_periodo", "inalo", "inali", "inba", "insr", "inoeconv", "inoeeven", "inoe", "inoio", "intio", "tipo_encuesta");
            ...
            case 9: //Descarga consolidado modulo IV
                ...
                $headers = array("nro_orden", "nro_establecimientos", "ano_periodo", "mes_periodo", "ihdo", "ihoavd", "ihoatc", "ihoa", "icda", "icva", "ihpnvd", "ihpntc", "ihpn", "ihpnrvd", "ihpnrtc", "ihpnr", "huetot", "thsen", "thusen", "thdob", "thudob", "thtot", "mvor", "mvsr", "mvnr", "mvcr", "mvam", "mvotr", "mvott", "mvonr", "mvsnr", "mvnnr", "mvcnr", "mvamnr", "mvotnr", "mvottnr", "tipo_encuesta");
            ...
            case 10: //Descarga hist�rico consolidado todos los modulos
                ...
                $headers = array("nro_orden", "nro_establecimiento", "ano_periodo", "mes_periodo", "potpsfr", "potperm", "gpper", "pottcde", "gpssde", "pottcag", "gpppta", "potpau",
                    "gppgpa", "pottot", "gpsspot", "inalo", "inali", "inba", "insr", "inoe", "inoio", "intio", "ihdo", "ihoa", "icda", "icva", "ihpn", "ihpnrvd", "ihpnrtc", "ihpnr", "huetot", "mvnr",
                    "mvcr", "mvor", "mvsr", "mvotr", "mvott", "mvnnr", "mvcnr", "mvonr", "mvsnr", "mvotnr", "mvottnr", "thsen", "thusen", "thdob", "thudob", "thsui", "thusui", "thmult",
                    "thumult", "thotr", "thuotr", "thtot", "tipo_encuesta");
            ...
            case 11: //Descarga consolidado por empresa
                ...
                $headers = array("nro_orden", "nro_establecimientos", "ano_periodo", "mes_periodo", "potpsfr", "potperm", "gpper", "pottcde", "gpssde", "pottcag", "gpppta", "potpau",
                    "gppgpa", "pottot", "gpsspot", "inalo", "inali", "inba", "insr", "inoeconv", "inoeeven", "inoe", "inoio", "intio", "ihdo", "ihoavd", "ihoatc", "ihoa", "icda", "icva", "ihpnvd", "ihpntc", "ihpn", "ihpnr", "huetot",
                    "mvor", "mvsr", "mvnr", "mvcr", "mvam", "mvotr", "mvott", "mvonr", "mvsnr", "mvnnr", "mvcnr", "mvamnr", "mvotnr",  "mvottnr", "thsen", "thusen", "thdob", "thudob", "tipo_encuesta");
                $data = $this->consolidado->descargaPlanosConsolidadoEmpresa($ano_periodo, $mes_periodo);
                break;
            case 12: //Descarga miniencuesta
                $nomfile = "consolidadoMiniencuesta.xls";
                $headers = array("nro_orden", "nro_establecimiento", "ulocal", "id_empresa", "idnit", "iddv", "idnit_nuevo", "iddv_nuevo", "idproraz", "idnomcom", "iddirecc", "idmpio",
                    "iddepto", "idtelno", "idcorreo", "idpagweb", "idact", "fk_sede", "fk_subsede", "nro_region", "pottot", "ihdo", "icda", "intio", "inalo", "observaciones", "responde", 
                    "respoca", "teler", "emailr", "fk_novedad", "estado", "tipoEncuesta", "nom_critica");
                    $data = $this->modulo1->descargaPlanosMini($ano_periodo, $mes_periodo);
                break;
            case 13: //Descarga observaciones critica de la miniencuesta
                $nomfile = "observacionesCriticaMini.xls";
                $headers = array("nro_orden", "nro_establecimiento", "fecha", "descripcion", "usuario", "nom_usuario");
                    $data = $this->modulo1->descargaObsMini($ano_periodo, $mes_periodo);
                break;
            case 14: //directorio miniencuesta
                $nomfile = "directorioMiniencuesta.xls";
                $headers = array("nro_orden", "nro_establecimiento", "ulocal", "id_empresa", "idnit", "iddv", "idnit_nuevo", "iddv_nuevo", "idproraz", "idnomcom", "iddirecc", "idmpio",
                    "iddepto", "idtelno", "idcorreo", "idpagweb", "idact", "fk_sede", "fk_subsede", "nro_region", "fk_novedad", "estado", "tipoEncuesta", "nom_critica");
                    $data = $this->modulo1->descargaDirectorioMini($ano_periodo, $mes_periodo);
                break;
             case 15: //Descarga de Novedades
                $nomfile = "novedadesMini.xls";
                $headers = array("nro_orden", "nro_establecimiento", "ano_periodo", "mes_periodo", "fk_critico", "fecha_visita", "estado_empresa", "consulta_camara", "fk_novedad", "nom_novedad", "nom_func", "tel_func", "cargo_func", "obs_critico", "fk_coordinador", "aceptada", "obs_coordinador");
                $data = $this->novedad->descargaPlanosNovedadesMini($ano_periodo, $mes_periodo);
                break;
        }

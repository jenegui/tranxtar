	...
	public function descargaPlanosXLS($modulo){
		...
		switch($modulo){
			case 1: //Descarga de planos en excel para el modulo I
				    $nomfile = "modulo1.xls";
					$headers = array("ano_periodo","mes_periodo","nro_orden","nro_establecimiento","ulocal","idnit","iddv","idproraz","idact","iddirecc","iddepto","nom_depto","idmpio","nom_mpio","idtelno","idfaxno","idpagweb","idcorreo",
                                     "idnomcomest","iddireccest","iddeptoest","nom_deptoest","idmpioest","nom_mpioest","idtelnoest","idcorreoest","fk_novedad","fk_sede","nom_sede","fk_subsede","nom_subsede","fk_estado","estado");				    

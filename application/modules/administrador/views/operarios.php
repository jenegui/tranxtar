...
<div class="row">
    <div class="fivecol"><h1>Operarios</h1></div>
                    ...
                    <table width="100%" class="table">
                        <thead class="thead">
                            <tr>
                                ...
                                <th align="center" width="10%">Inactivar</th>
                                ...
                                if ($usuarios[$i]["nombre_operario"] != "") {
                                    ...
                                    <tr class="<?php echo $class; ?>">
                                        ...
                                        <td align="center">
                                            ...
                                            ?>
                                            <a href="javascript:eliminarUsuarioADM(<?php echo $usuarios[$i]["id_operario"]; ?>);"><img src="<?php echo base_url("images/delete.png"); ?>" border="0"/></a>
                                            <?php //}   ?>
                                            <?php //}   ?>	
                                        </td>

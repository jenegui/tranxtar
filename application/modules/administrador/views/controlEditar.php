	...
	<tr>
	  ...
	  <td>
	      ...
	      <?php 
              ...
              <option value="3" <?php echo $selectd3; ?>>Cr&eacute;ito</option>
            </select>
          </td>    
	</tr>
        <tr>
	  ...
	  <td>Operario externo:</td>
            <td><select id="idoperarioext" name="idoperarioext" class="select">
                ...
                <?php for ($i=0; $i<count($operariosExt); $i++){ 
                    if($control["id_operario"]==$operariosExt[$i]["nro_identificacion"]){
                ?>
                    <option value="<?php echo $operariosExt[$i]["nro_identificacion"]; ?>" selected="selected"><?php echo $operariosExt[$i]["nombre_operario"]; ?></option> 
                 <?php 	} 
                    else{
...
<br/>
<input type="submit" id="btnEditarGuia" name="btnEditarGuia" value="Editar Guia" class="button"/>

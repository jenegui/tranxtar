...
class Control extends CI_Model {
	...
	//Crea los registros de control cuando se realiza el cargue masivo del directorio
	 function insertarControl($nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, $nueva, $modulo1, $modulo2, $modulo3, $modulo4, $modulo5, $envio, $inclusion, $control, $fk_novedad, $fk_estado, $fk_sede, $fk_subsede, $fk_usuariocritica, $fk_usuariologistica){

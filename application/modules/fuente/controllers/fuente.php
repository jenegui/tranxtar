...
class Fuente extends MX_Controller {
    ...
    public function generarPazySalvo(){
    	...
    	if($this->session->userdata("nro_establecimiento")!=""){
            $nro_orden = $this->session->userdata("nro_orden");
        }else{
		...
		foreach($_POST as $nombre_campo => $valor){
			$asignacion = "\$" . $nombre_campo . "='" . $valor . "';";   			
  			eval($asignacion);
                ...
                if (!isset($obsidproraz)){
			$obsidproraz = "";
		}
		$this->modulo1->actualizarModulo($nro_orden, $nro_establecimiento, $idnit, $idproraz, $idnomcom, $idsigla, $iddirecc, $iddepto, $idmpio, $idtelno, $idfaxno, $idpagweb, $idcorreo, $finicial, $ffinal, $idnomcomest, $iddireccest, $iddeptoest, $idmpioest, $idtelnoest, $idfaxnoest, $idcorreoest, $nom_cadena, $nom_operador);
		$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 1, 'idproraz', $idproraz, $obsidproraz);
	...
	if (($op=='insert')&&($estado==0)){
			...
			$this->modulo2->insertarModulo($potpsfr, $potperm, $pottcde, $pottcag, $potpau, $pottot, $gpper, $gpssde, $gpppta, $gppgpa, $gpsspot, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo);
			//Actualizar el registro de la tabla de control
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 2, 'gpper', $gpper, $obsgpper);
			...
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 2, 'pottot', $pottot, $obspottot);
                        $this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 2, 'gpppta', $gpppta, $obsgpppta);
		...
		elseif(($op=='update')&&($estado!=0)){
			...
			$this->modulo2->actualizarModulo($potpsfr, $potperm, $pottcde, $pottcag, $potpau, $pottot, $gpper, $gpssde, $gpppta, $gppgpa, $gpsspot, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo);
			//Actualizar el registro de la tabla de control
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 2, 'gpper', $gpper, $obsgpper);
                        $this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 2, 'gpssde', $gpssde, $obsgpssde);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 2, 'pottot', $pottot, $obspottot);
...
//Funciones AJAX
	...
	public function actualizarModuloIII(){
		...
		if (($op=='insert')&&($estado==0)){
			...
			$this->modulo3->insertarModulo($inalo, $inalovd, $inaloatc, $inali, $inba, $insr, $inoeconv, $inoeeven, $inoe, $inoio, $intio, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo);
			//Actualizar el registro de la tabla de control
			...
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'inali', $inali, $obsinali);
			...
			//$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'incat', $incat, $obsincat);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'inalo3', $inalo, $obsinalo3);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'inba', $inba, $obsinba);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'insr', $insr, $obsinsr);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'inoe', $inoe, $obsinoe);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'inoio', $inoio, $obsinoio);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'intio3', $intio, $obsintio3);
			...
			$this->modulo3->actualizarModulo($inalo, $inalovd, $inaloatc, $inali, $inba, $insr, $inoeconv, $inoeeven, $inoe, $inoio, $intio, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo);
			//Actualizar el registro de la tabla de control
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'intio1', $intio, $obsintio1);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'intio2', $intio, $obsintio2);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 3, 'inalo', $inalo, $obsinalo);
	...
	public function actualizarModuloIV(){
		...
		if (($op=='insert')&&($estado==0)){
			...
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 4, 'huetot1', $huetot1, $obshuetot1);
			...
			//Update sobre el registro de la tabla del modulo IV
                        $this->modulo4->actualizarModulo($ihdo, $ihoa, $ihoavd, $ihoatc, $icda, $icva,  $ihpnvd, $ihpntc, $ihpn, $ihpnrvd, $ihpnrtc, $ihpnr, $huetot, $mvnr, $mvcr, $mvor, $mvsr, $mvotr, $mvam, $mvamnr, $mvott, $mvnnr, $mvcnr, $mvonr, $mvsnr, $mvotnr, $mvottnr, $thsen, $thusen, $thdob, $thudob, $thsui, $thusui, $thmult, $thumult, $thotr, $thuotr, $thtot,  $tphto, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo);
			//Actualizar el registro en la tabla de control
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 4, 'ihoa', $ihoa, $obsihoa);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 4, 'icva', $icva, $obsicva);
			$this->observaciones->actualizarObservacion($id_usuario, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo, 4, 'huetot', $huetot, $obshuetot);

...
class Modulo2 extends CI_Model {
	...
	function actualizarModulo($potpsfr, $potperm, $pottcde, $pottcag, $potpau, $pottot, $gpper, $gpssde, $gpppta, $gppgpa, $gpsspot, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    ...
    function insertarModulo($potpsfr, $potperm, $pottcde, $pottcag, $potpau, $pottot, $gpper, $gpssde, $gpppta, $gppgpa, $gpsspot, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('potpsfr' => $potpsfr, 
    	              'potperm' => $potperm, 
    	              'pottcde' => $pottcde, 
    	              'pottcag' => $pottcag, 

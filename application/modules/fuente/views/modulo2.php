...
<h3>M&oacute;dulo II - Personal ocupado promedio en el mes, sueldos y salarios causados en el mes</h3>
<br/>
...
<div id="esto"></div>
  ...
  <td style="text-align:center"><input type="text" id="potpsfr" name="potpsfr" value="<?php echo $modulo2["potpsfr"]; ?>" size="7" <?php $this->general->bloqueoCampo($bloqueo); ?> class="textbox"/> <div id="aviso" style="color:red"></div></td>
...
<tr>
  <td style="text-align:left">3. Personal temporal contratado directamente<br/>(Contrato a t&eacute;rmino definido)</td>
...
<tr>
  <td style="text-align:left">6. Total</td>
  <td style="text-align:center"><input type="text" id="pottot" name="pottot" value="<?php echo $modulo2["pottot"]; ?>" size="7" <?php $this->general->bloqueoCampo($bloqueo); ?> class="textbox"/></br><font style="color: red">Sume numerales del 1 al 5.</font></td>
  <td style="text-align:center"><input type="text" id="gpsspot" name="gpsspot" value="<?php echo $modulo2["gpsspot"]; ?>" <?php $this->general->bloqueoCampo($bloqueo); ?> class="textbox" size="7"/></br><font style="color: red">Sume numerales 2,3 y 5.</font></td>
  <td style="text-align:center">&nbsp;</td>
</tr>
</tbody>
</table>
...
<div id="divpottot"></div>
<div id="mensajegpper"></div>
<div id="divgpper"></div>
<div id="mensajegpssde"></div>
<div id="divgpssde"></div>
<div id="mensajegpppta"></div>
<div id="divgpppta"></div>
<div id="mensajegppgpa"></div>

...
?>
<?php 
if($modulo1["nro_establecimiento"]==''){
	echo "Al establecimiento no se le ha creado control, favor comuniquese con administrador del sistema.";  
	exit;
}
echo "($nro_orden - $nro_establecimiento)  ".$modulo1["idnomcomest"]. " - Actividad: ".$modulo1["fk_ciiu"]. " - ".$modulo1["nom_ciiu"]; 
?>
<div id="content">
	<br/>
	<div id="tabs">

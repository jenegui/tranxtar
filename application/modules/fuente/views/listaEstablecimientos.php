				...
				$html.='<td align="center">'.$estabEmpresa[$i]["nro_establecimiento"].'</td>';
		  		...
		  		if($cierre!="ListaEstUlocal"){
			  		if($estabEmpresa[$i]["estadoEst"]==1){
						$cierre="cierre";
			  			$html.='<td align="center"><a href="'.site_url("/fuente/cierre_establecimientos/$establecimiento/$cierre").'" title="Haga click aqui para marcar cierre del estableciminetio">Abierto</a></td>';
			  		}else{
						$html.='<td align="center"><a href="'.site_url("/fuente/cierre_establecimientos/$establecimiento/$cierre").'" title="Haga click aqui para marcar el estableciminetio como activo">Cerrado</a></td>';
					}
				}
		  	$html.='</tr>';
		  	echo $html;

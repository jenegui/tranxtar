...
<tr>
  ...
  <tr>
    <td align="justify">RINDI&Oacute; LA ENCUESTA MENSUAL DE ALOJAMIENTO CORRESPONDIENTE AL PERIODO <b><?php echo strtoupper($pyz["periodo"]); ?></b> Y CUMPLI&Oacute; CON LOS REQUISITOS ESTABLECIDOS EN LA LEY 0079 DEL 20 DE OCTUBRE DE 1993, POR
        LO CUAL HA SIDO INSCRITA EN SUS ARCHIVOS EN LA ACTIVIDAD DE SERVICIOS CIIU REV3. EL ESTABLECIMIENTO DEBER&Aacute; IDENTIFICARSE CON EL N&Uacute;MERO: <?php echo $pyz["nro_establecimiento"]; ?> PARA TODOS LOS TR&Aacute;MITES
  ...
  <tr>
    <td>FECHA DE EXPEDICI&Oacute;N: <?php echo date("d/m/Y"); ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>

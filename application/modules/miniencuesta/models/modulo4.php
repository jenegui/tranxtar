...
class Modulo4 extends CI_Model {
    ...
    function actualizarModulo($ihdo,$icda, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('ihdo' => $ihdo, 'icda' => $icda);
    ...
    function insertarModulo($ihdo,$icda, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('ihdo' => $ihdo, 'icda' => $icda,
                        'nro_orden' => $nro_orden,

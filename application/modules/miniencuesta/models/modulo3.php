...
class Modulo3 extends CI_Model {
    ...
    function actualizarModulo($intio, $inalo, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    ...
    function insertarModulo($intio, $inalo, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('inalo' => $inalo,
    	              'intio' => $intio,
    	              'nro_orden' => $nro_orden,

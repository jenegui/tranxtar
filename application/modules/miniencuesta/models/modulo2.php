...
class Modulo2 extends CI_Model {
    ...
    function actualizarModulo($pottot, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('pottot' => $pottot);
    ...
    function insertarModulo($pottot, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('pottot' => $pottot, 
        'nro_orden' => $nro_orden, 

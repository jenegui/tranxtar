...
<td>
    <table width="100%">
    <tr>
      <td><label style="display: block; float: left; width: 120px;">Motivo del cierre:&nbsp; <textarea cols="120" rows="5" name="motivoCierre" id="motivoCierre"><?php echo $establec["observaciones"] ?></textarea></label></td>
    </tr>
    </table>
</td>
</tr>

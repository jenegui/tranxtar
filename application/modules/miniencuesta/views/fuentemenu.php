...
<div id="menu" class="row">
	<div class="twelvecol last">
		<ul>
			...
			<?php //} ?>			
			<!-- li style="padding-top: 3px;"><a href="<?php echo site_url("miniencuesta/descarga"); ?>">Formulario&nbsp;<img src="<?php //echo base_url("images/acrobat.png"); ?>" title="Formulario en Blanco" border="0"/></a></li -->
			<li style="padding-top: 3px;"><a href="<?php echo site_url("miniencuesta/descargaManual"); ?>">Manual diligenciamiento&nbsp;<img src="<?php echo base_url("images/acrobat.png"); ?>" title="Manual Diligenciamiento" border="0"/></a></li>

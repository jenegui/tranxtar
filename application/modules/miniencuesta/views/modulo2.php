...
<tr>
  ...
  <td style="text-align:center"><input type="text" id="pottot" name="pottot" value="<?php echo $modulo2["pottot"]; ?>" size="7" <?php $this->general->bloqueoCampo($bloqueo); ?> class="numbox"/></td>

		...
		$generalesRegion.='<thead>';
			...
			for($i=0; $i<=count($regiones)-1; $i++){
				...
				$generalesRegion.='<tr>';
					...
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($establec["anual".$i]/$establec["anual".$ultimoRegion])*100),2,',','.').'</td>';
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($establec["anterior".$i]/$establec["anterior".$ultimoRegion])*100),2,',','.').'</td>';
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($establec["actual".$i]/$establec["actual".$ultimoRegion])*100),2,',','.').'</td>';
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.@number_format((($establec["actual".$i]-$establec["anterior".$i])/($establec["actual".$ultimoRegion]-$establec["anterior".$ultimoRegion])*($varMensualEst[$ultimoRegion])),2,',','.').'</td>';
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($establec["actual".$i]-$establec["anual".$i])/($establec["actual".$ultimoRegion]-$establec["anual".$ultimoRegion])*($varAnualEst[$ultimoRegion])),2,',','.').'</td>';
					//Ingresos
					...
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($ingresos["anual".$i]/$ingresos["anual".$ultimoRegion])*100),2,',','.').'</td>';
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($ingresos["anterior".$i]/$ingresos["anterior".$ultimoRegion])*100),2,',','.').'</td>';
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($ingresos["actual".$i]/$ingresos["actual".$ultimoRegion])*100),2,',','.').'</td>';
					//Variación ingresos
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($ingresos["actual".$i]-$ingresos["anterior".$i])/($ingresos["actual".$ultimoRegion]-$ingresos["anterior".$ultimoRegion])*($varMensualIng[$ultimoRegion])),2,',','.').'</td>';
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($ingresos["actual".$i]-$ingresos["anual".$i])/($ingresos["actual".$ultimoRegion]-$ingresos["anual".$ultimoRegion])*($varAnualIng[$ultimoRegion])),2,',','.').'</td>';
					//Personal
					...
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($personal["anual".$i]/$personal["anual".$ultimoRegion])*100),2,',','.').'</td>';
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($personal["anterior".$i]/$personal["anterior".$ultimoRegion])*100),2,',','.').'</td>';
					@$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($personal["actual".$i]/$personal["actual".$ultimoRegion])*100),2,',','.').'</td>';
					//Variación Personal
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($personal["actual".$i]-$personal["anterior".$i])/($personal["actual".$ultimoRegion]-$personal["anterior".$ultimoRegion])*($varMensualPer[$ultimoRegion])),2,',','.').'</td>';
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.number_format((($personal["actual".$i]-$personal["anual".$i])/($personal["actual".$ultimoRegion]-$personal["anual".$ultimoRegion])*($varAnualPer[$ultimoRegion])),2,',','.').'</td>';
					//Camas ofrecidas
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.@number_format((($inalo["actual".$i]-$inalo["anual".$i])/($inalo["actual".$ultimoRegion]-$inalo["anual".$ultimoRegion])*($varAnualInalo[$ultimoRegion])),2,',','.').'</td>';
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.@number_format((($huetot["actual".$i]-$huetot["anual".$i])/($huetot["actual".$ultimoRegion]-$huetot["anual".$ultimoRegion])*($varAnualHuetot[$ultimoRegion])),2,',','.').'</td>';
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.@number_format((($icva["actual".$i]-$icva["anual".$i])/($icva["actual".$ultimoRegion]-$icva["anual".$ultimoRegion])*($varAnualIcva[$ultimoRegion])),2,',','.').'</td>';
					...
					$generalesRegion.='<td class="'.$var.'" style="border-right: 1px solid #CCCCCC; font-size: 10px;" align="center">'.@number_format((($ihoa["actual".$i]-$ihoa["anual".$i])/($ihoa["actual".$ultimoRegion]-$ihoa["anual".$ultimoRegion])*($varAnualIhoa[$ultimoRegion])),2,',','.').'</td>';
					//Estancia media

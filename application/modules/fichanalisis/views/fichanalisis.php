...
<tr class="row2">
  <td align="left">Servicios de restaurante y catering para eventos (alimentos y bebidas no alcoh&oacute;licas), no incluidos en el valor de la tarifa de alojamiento (INALI)</td>
...
<tr>
  <td align="left">Servicios de bar (bebidas alcoh&oacute;licas y cigarrilos), no incluidos en el valor de la tarifa de alojamiento (INBA)</td>
...
<tr class="row2">
  <td align="left"> Servicios receptivos y conexos (INSR)</td>
  ...
  <?php if (($insr["err1"])||($insr["err2"])){  ?>
  		<td align="center"><a href="javascript:corregirFicha(3,'insr');">Corregir</a></td>
...
<tr class="row1">
  <td align="left">Organizacion de convenciones MICE (INOE)</td>
...
<tr class="row2">
  <td align="left">Otros ingresos operacionales no solicitados anteriormente (INOIO)</td>
...
<tr class="row1">
  <td align="left">Total de ingresos operacionales (INTIO)</td>
...
<tr class="row2">
  <td align="left">Total  sueldos y salarios /  Total Ingresos</td>
...
<tr class="row1">
  ...
  <?php if (($thudob["err1"])||($thudob["err2"])){  ?>

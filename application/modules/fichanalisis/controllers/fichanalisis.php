...
class Fichanalisis extends MX_Controller {
	...
	public function index(){
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"],$rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,4); //Se presentan errores en el indice 3 (INBA)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"],$rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,5); //Se presentan errores en el indice 4 (INOE)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango); //Se compara si el valor está dentro del rango de [-15,15] 
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,6); //Se presentan errores en el indice 5 (INOIO)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,7); //Se presentan errores en el indice 6 (INTIO)
		}
		...
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,8); //Se presentan errores en el indice 7 (POTTOT)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,9); //Se presentan errores en el indice 8 (POTPSFR)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,10); //Se presentan errores en el indice 9 (POTPERM)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,11); //Se presentan errores en el indice 10 (GPPER)
		}
		...
		$data[$index]["err2"] = $this->ficha->compararRango($data[$index]["varanual"], $rango);
	    if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,12); //Se presentan errores en el indice 11 (SALPPER)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,13); //Se presentan errores en el indice 12 (POTTCDE)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,14); //Se presentan errores en el indice 13 (GPSSDE)
		}
		...
		$data[$index]["err2"] = $this->ficha->compararRango($data[$index]["varanual"], $rango);
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,15); //Se presentan errores en el indice 14 (SALTDIR)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);		
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,16); //Se presentan errores en el indice 15 (POTTCAG)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,17); //Se presentan errores en el indice 16 (GPPPTA)
		}
		...
		$data[$index]["err2"] = $this->ficha->compararRango($data[$index]["varanual"], $rango);
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,18); //Se presentan errores en el indice 17 (SALTSUM)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,19); //Se presentan errores en el indice 18 (POTPAU)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,20); //Se presentan errores en el indice 19 (GPPGPA)
		}
		...
		$data[$index]["err2"] = $this->ficha->compararRango($data[$index]["varanual"], $rango);
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,21); //Se presentan errores en el indice 20 (SALPAPRE)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango);
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,22); //Se presentan errores en el indice 21 (GPSSPOT)
		}
		...
		$data[$index]["err2"] = $this->ficha->compararRango($data[$index]["varanual"], $rango);
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,23); //Se presentan errores en el indice 22 (SALTOTING)
		}
		...
		*/
		...
		//Se comenta, ya que en la ficha de análisis no se está mostrando entancia media 2 sjneirag    
		/*if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,31); //Se presentan errores en el indice 30 (ESTMEDIA2)
		} */ 
		...
		$data[$index]["err2"] = $this->ficha->compararRango($data[$index]["varanual"], $rango);
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			array_push($erroresIndices,41); //Se presentan errores en el indice 28 (INGVSSAL)
		} 
		...
		if (($data[$index]["err1"])||($data[$index]["err2"])){
			...
			array_push($erroresIndices,42); //Se presentan errores en el indice 28 (INGVSSAL)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango); //Se compara si el valor está dentro del rango de [-15,15]
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,25); //Se presentan errores en el indice 1 (INALO)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango); //Se compara si el valor está dentro del rango de [-15,15]
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,26); //Se presentan errores en el indice 1 (INALO)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango); //Se compara si el valor está dentro del rango de [-15,15]
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,27); //Se presentan errores en el indice 1 (INALO)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango); //Se compara si el valor está dentro del rango de [-15,15]
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,28); //Se presentan errores en el indice 1 (INALO)
		}
		...
		$data[$campo]["err2"] = $this->ficha->compararRango($data[$campo]["varanual"], $rango); //Se compara si el valor está dentro del rango de [-15,15]
		if (($data[$campo]["err1"])||($data[$campo]["err2"])){
			array_push($erroresIndices,29); 
		}
		
                if($data["ihoa"]["varanual"]>0 && $data["huetot"]["varanual"]<=0){

...
<td>
	...
	<tr>
	  <td>
                ...
                <label style="display: block; float: left; width: 105px; text-align: right;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; DV:&nbsp;<?php echo $modulo1["iddv"]; ?></label>
	  </td>	  
	</tr>
	</table>
</td>
...
<td>
	...
	<tr>
	  ...
	  <td><label style="display: block; float: left; width: 400px;">&nbsp;Municipio: 
	      <select id="idmpio" name="idmpio" class="select" <?php echo $this->general->bloqueoCampo($bloqueo); ?>>
          <option value="-">Seleccione...</option>
...
<td>
	...
	<tr>
	  ...
	  <td><label style="display: block; float: left; width: 550px;">P&aacute;gina web:&nbsp;<input type="text" placeholder="http://www.ejemplo.com" id="idpagweb" name="idpagweb" value="<?php echo $modulo1["idpagweb"]; ?>" size="60" maxlength="255" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
	</tr>
	</table>
</td>
</tr>
...
<td>
    <table width="100%">
    <tr>
      <td><label style="display: block; float: left; width: 620px;">Email gerencia:&nbsp;<input type="text" placeholder="you@ejemplo.com" id="idcorreo" name="idcorreo" value="<?php echo $modulo1["idcorreo"]; ?>" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
    </tr>
    </table>
</td>
</tr>
...
<td>
	<table width="100%">
	<tr>
	  <td><label style="display: block; width: 850px;">Nombre comercial del establecimiento:&nbsp;&nbsp;&nbsp;<input type="text" id="idnomcomest" name="idnomcomest" value="<?php echo $modulo1["idnomcomest"]; ?>" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?> /></label>
...
<td>
	...
	<tr>
	  ...
	  <td><label style="display: block; float: left; width: 400px;">&nbsp;Municipio: 
          ...
          <option value="-">Seleccione...</option>
	      <?php for ($i=0; $i<count($municipios); $i++){
	  				if (trim($municipios[$i]["codigo"])==trim($modulo1["idmpioest"])){ 
	      ?>			<option value="<?php echo $municipios[$i]["codigo"]; ?>" selected="selected"><?php echo $municipios[$i]["nombre"]; ?></option>
	      <?php     }
	  				else{ ?>
	  					<option value="<?php echo $municipios[$i]["codigo"]; ?>"><?php echo $municipios[$i]["nombre"]; ?></option>
...
<td>
	...
	<tr>
	  ...
	  <td><label style="display: block; float: left; width: 550px;">Email establecimiento:&nbsp;<input type="text" placeholder="you@ejemplo.com" id="idcorreoest" name="idcorreoest" value="<?php echo $modulo1["idcorreoest"]; ?>" size="60" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
	</tr>
	</table>
</td>  
</tr>
...
<br/>
<?php //Validar que el formulario est� en estado 99 - 5 para poder ser activado por el administrador 
...
<input type="hidden" id="idnomcom" name="idnomcom" value=" "/>

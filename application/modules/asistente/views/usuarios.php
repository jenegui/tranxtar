   ...
   ?>
	   <tr class="<?php echo $class; ?>">
	     <td>&nbsp;&nbsp;<?php echo $criticos[$i]["nombre"]; ?></td>
             <td><?php echo utf8_decode($criticos[$i]["rol"]); ?></td>
	     ...
	     <td align="center">
	   		 <?php //if (($reciente["ano"]==$ano)&&($reciente["mes"]==$mes)){ ?>
	   		 	<a href="<?php echo site_url("asistente/asignarFuentes/".$criticos[$i]["id"]."/".$criticos[$i]["sedeNumero"]."/".$criticos[$i]["subsedeNumero"]); ?>"><img src="<?php echo base_url("images/go.png"); ?>" border="0"/></a>
	   		 <?php //} ?>	
	     </td>
	   </tr>
   <?php } ?>

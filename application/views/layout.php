    ...
    <head>
        ...
        <!--[if lte IE 9]><link rel="stylesheet" href="<?php echo base_url("css/ie.css"); ?>" type="text/css" media="screen" /><![endif]-->
            ...
            <?php if (($controller != "fuente") && ($controller != "login") && ($controller != "indicadorcalidad")) { ?>
                ...
                <?php } elseif ($controller == "empresa") {
                    ?>
                    <!-- empresa -->
                    <script type="text/javascript" src="<?php echo base_url("js/empresa/jsmodulo1.js"); ?>"></script>
                <?php } elseif ($controller == "miniencuesta") {
                    ?>
                    <!-- empresa -->
                    <script type="text/javascript" src="<?php echo base_url("js/miniencuesta/jsmodulo1.js"); ?>"></script>
                <?php } elseif ($controller == "asistente") {
                    ?>
                    <!-- Asistente -->	
                    <script type="text/javascript" src="<?php echo base_url("js/asistente/jsasistente.js"); ?>"></script>
                <?php } elseif ($controller == "logistica") {
                    ?>
                    <!-- Logistica -->
                    <script type="text/javascript" src="<?php echo base_url("js/logistica/jslogistica.js"); ?>"></script>
                <?php } elseif ($controller == "tematica") {
                    ?>
                    <!-- Logistica -->

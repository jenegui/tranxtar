...
@section('content')
    <header>
        <div class="container">
          <div class="brand">
            <h1 class="brand_name"><a href="./">Thot Cloud System</a></h1>
            <br><p class="brand_slogan">Aplicaci&oacute;n web contable</p>
          </div>
          <p>Uno de nuestros representes podr&aacute; atender sus necesidaes, ll&aacute;menos al</p>
          <a href="callto:#" class="fa-phone">+57 316 6780490</a>

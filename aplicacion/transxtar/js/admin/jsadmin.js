...
$(function () {
    ...
    $("#btnAgregar").click(function () {
        $("#agregarFuente").dialog({
         ...
         $.ajax({
                    type: "POST",
                    url: base_url + "administrador/formularios",
    ...
    $("#btnGenerarUsuarios").click(function () {
        $.ajax({
            type: "POST",
            url: base_url + "administrador/GeneraUsuarios",
            data: $("#frmGenerarUsuarios").serialize(),
            dataType: "html",
            cache: false,
            success: function (data) {
                //form.submit();
        ...
        $("#frmAgregarGuia").validate({
            rules: {
                ...
                estadocarga: {
                    required: true,
                    comboBox: '-',
                    expresion: 'parseInt($("#estadoRecogida").val())== 0 &&  parseInt($("#estadocarga").val()) > 1'
                },
            ...
            messages: {
                ...
                estadocarga: {
                    required: "Debe seleccionar una opción",
                    comboBox: "Debe seleccionar una opción",
                    expresion: "Falta aprobacion de la guia"
                },
    ...
    $("#btnEditarGuiaTS").click(function () {
        ...
        $("#frmEditarGuiaTS").validate({
            ...
            submitHandler: function (form) {
                $.ajax({
                    type: "POST",
                    url: base_url + "traficoseguridad/actualizarDatosControlTS",
...
$(document).ready(function(){
    ...
    $('#tablaControl tbody').on('click', 'td.details-control', function () {
...
$(document).ready(function(){
    ...
    $('#tablaControlcliente').dataTable( {
                    ...
                    "responsive": true,
                    "bProcessing": true,
                    "sAjaxSource": base_url +"cliente/directorioControl",
                     "aoColumns": [
                             { mData: 'NumGuia' } ,
                            { mData: 'numRemesa' } ,
                            { mData: 'nomCliente' },
...
$(document).ready(function(){
    $('#tablaControlLog').dataTable( {
                    ...
                    "responsive": true,
                    "bProcessing": true,
                    "sAjaxSource": base_url +"logistica/directorioControl",
                     "aoColumns": [
                            { mData: 'NumGuia' } ,
                            { mData: 'nomCliente' },
                            { mData: 'ciudadOrigen' },
...
$(document).ready(function(){
   $("a.external").live('click', function() {
      url = $(this).attr("href");
      window.open(url, '_blank',"toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=700,height=600");
      return false;
   });
});
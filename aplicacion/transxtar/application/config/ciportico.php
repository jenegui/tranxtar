...
/**
 * Project specific Reportico configuration
 */
...
$config['url_path_to_assets'] = '/assets/reportico/';

/**
 * Setup URL handler for Reportico calls – must be same as Controller with reportico->execute()
 */
$config['ciportico_base'] = "reporter";

...
class Usuario extends CI_Model {
                ...
                foreach ($query->result() as $row) {
                    ...
                    if (strcmp($encryptClave, $row->pass_usuario) == 0) {
                        ...
                        $sessionData = array('auth' => trim('OK'),
                            ...
                            'controlador' => $this->asignarControlador($row->fk_rol));
    ...
    /**
     * Funcion que obtiene el controlador al que debe ser reenviado el usuario dependiendo de su rol de usuario
     * @author dmdiazf
     * @since  30/08/2016
     */
     ...
     * 
      ...
      //Daniel M. D�az - Junio 07 2012
      //Valida usuario y contrase�a utilizando encriptacion MD5 para la contrase�a.
      ...
      //Funcion para consultar si una fuente ya se encuentra registrada para un a�o mes.
      ...
      //Obtiene todas las fuentes que se encuentran en la misma sede de un usuario. (Asistente T�cnico)

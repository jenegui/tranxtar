...
if(count($lista_estab)<=0){
	echo '<div style="color:#FF0000;" align="center">No hay establecimientos pendientes por asignaci&oacute;n usuarios!!!</div>';
}
else{
	?>
		...
		<form id="frmGenerarUsuariosEmp" name="frmGenerarUsuariosEmp" method="post" action="">
		...
		<br>	
		<div><input type="hidden" id="generaUsuEstab" name="generaUsuEstab" value=""/></div>
		<div align="center"><input type="button" id="btnGenerarUsuariosEmp" name="btnGenerarUsuariosEmp" value="GenerarUsuarios" class="button"/></div>

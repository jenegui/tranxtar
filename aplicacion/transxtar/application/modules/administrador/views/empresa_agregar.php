...
<tr>
  <td>Nro. Orden:</td>
  <td><input type="hidden" id="txtNroOrden" name="txtNroOrden" value="<?php echo $ultimoOrden+1; ?>"/><?php echo $ultimoOrden+1; ?></td>
</tr>
<tr>
  <td>Nit Empresa:</td>
...
<tr>
  ...
  <td><input type="hidden" id="txtNomComercial" name="txtNomComercial" value=""/></td>
  <td><input type="hidden" id="txtSigla" name="txtSigla" value=""/></td>
</tr>
</table>
</form>
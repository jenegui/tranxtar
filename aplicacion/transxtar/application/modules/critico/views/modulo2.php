...
<tr>
  ...
  <td style="text-align:center"><input type="text" id="pottot" name="pottot" value="<?php echo $modulo2["pottot"]; ?>" size="7" <?php $this->general->bloqueoCampo($bloqueo); ?> class="numbox"/></br><font style="color: red">Sume numerales del 1 al 5.</font></td>
...
<br/>
<?php //Validar que el formulario est� en estado 99 - 5 para poder ser activado por el critico

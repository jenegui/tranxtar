...
class Modulo4 extends CI_Model {
    ...
    function obtenerModulo($nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$modulo4 = array();
    	$sql = "SELECT C.modulo4, CH.ihdo, CH.ihoa, CH.ihoavd, CH.ihoatc, CH.icda, CH.icva, CH.ihpn, CH.ihpnr, CH.huetot, CH.mvnr, CH.mvnnr, CH.mvcr, CH.mvcnr, CH.mvor, CH.mvonr,
    ...
    function actualizarModulo($ihdo, $ihoa, $ihoavd, $ihoatc, $icda, $icva, $ihpn, $ihpnr, $huetot, $mvnr, $mvcr, $mvor, $mvsr, $mvotr, $mvam, $mvamnr, $mvott, $mvnnr, $mvcnr, $mvonr, $mvsnr, $mvotnr, $mvottnr, $thsen, $thusen, $thdob, $thudob, $thsui, $thusui, $thmult, $thumult, $thotr, $thuotr, $thtot, $tphto, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
		...
		$this->db->where("nro_unidad_local", $nro_establecimiento);
    ...
    function insertarModulo($ihdo, $ihoa, $ihoavd, $ihoatc, $icda, $icva, $ihpn, $ihpnr, $huetot, $mvnr, $mvcr, $mvor, $mvsr, $mvotr, $mvam, $mvamnr, $mvott, $mvnnr, $mvcnr, $mvonr, $mvsnr, $mvotnr, $mvottnr, $thsen, $thusen, $thdob, $thudob, $thsui, $thusui, $thmult, $thumult, $thotr, $thuotr, $thtot, $tphto, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('ihdo' => $ihdo, 'ihoa' => $ihoa,
    			      'ihoavd' => $ihoavd, 'ihoatc' => $ihoatc,
    	              'icda' => $icda, 'icva' => $icva, 
    	              'ihpn' => $ihpn, 'ihpnr' => $ihpnr, 
    			      ...
    			      'nro_unidad_local' => $nro_establecimiento,

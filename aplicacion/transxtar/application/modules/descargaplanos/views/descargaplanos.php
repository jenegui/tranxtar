...
<table width="100%">
	...
	<tr>
        ...
        <tr>
            <td style ="vertical-align:text-top;">
                    <fieldset class="fieldset">
                    <legend><h1>Descarga de planos de la miniencuesta</h1></legend>
                    <p>Seleccione el m&oacute;dulo a descargar: </p>
                    <br/>
                    <ul>
                      <li style="padding-left: 10px;"><a href="<?php echo site_url("descargaplanos/descargaPlanosXLS/12"); ?>">Descargar miniencuesta</a></li>
                      <li style="padding-left: 10px;"><a href="<?php echo site_url("descargaplanos/descargaPlanosXLS/13"); ?>">Observaciones Critica</a></li>
                      <li style="padding-left: 10px;"><a href="<?php echo site_url("descargaplanos/descargaPlanosXLS/14"); ?>">Directorio miniencuesta</a></li>
                      <li style="padding-left: 10px;"><a href="<?php echo site_url("descargaplanos/descargaPlanosXLS/15"); ?>">Novedades miniencuesta</a></li>
                    </ul>
                    </fieldset>
            </td>
	</tr>

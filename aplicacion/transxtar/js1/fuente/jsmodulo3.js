...
$(function () {
    ...
    $("#insrr").hint("City tours, gu&iacute;as tur&iacute;sticos, organizaci&oacute;n de viajes, operadores, servicios similares y conexos.");
    ...
    $("#intio").cajaObservaciones('(parseInt($("#inali").val())+parseInt($("#inba").val())+parseInt($("#insc").val())+parseInt($("#inos").val())+parseInt($("#insr").val())+parseInt($("#inoe").val())+parseInt($("#inoio").val())) > parseInt($("#inalo").val())', 'divintio3', mensajeINTIO3, 'obsintio3');
...
function obtenerMensaje3(campo) {
    ...
    switch (campo) {
        ...
        case 'insr':
            ...
            break;
        case 'inoe':
            mensaje = "Justificar por qu&eacute; los ingresos por organizaci&oacute;n de eventos son mayores que los ingresos por alojamiento, y especifique los principales eventos realizados.";
            break;
        case 'intio':
            mensaje = "Discrimine los otros ingresos operacionales.";
            break;
        case 'intio3':
            mensaje = "Justifique el porque sus ingresos diferentes a alojamiento son  mayores a los de alojamiento.";
            break;
    }
    return mensaje;

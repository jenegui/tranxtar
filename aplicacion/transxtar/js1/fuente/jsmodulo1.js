...
$(function(){
	var mensajeIDPRORAZ = "Si modific&oacute; alg&uacuten campo de este m&oacute;dulo debe justificar.";
	...
	$("#idcorreoest").minusculas().largo(80);
        ...
        $(".cambios").cajaObservaciones2('$(".cambios").val() != "" ','dividproraz',mensajeIDPRORAZ,'obsidproraz');

...
/*****/
	...
	var base_url = "/transxtar_final/aplicacion/transxtar/";  //Ruta base para ejecutar AJAX en CodeIgniter
	...
	//* Mostrar Ocultar caja de texto de observaciones para la fuente 
	//**************************************************************************************************
	$.fn.cajaObservaciones1 = function(expresion, div, mensaje, nombreCaja){
		return this.blur(function(event){  
			var contenido = "";
			var mydiv = "#" + div;			
			$(mydiv).empty();
	...
	//* Mostrar Ocultar caja de texto de observaciones para la fuente 
	//**************************************************************************************************
	$.fn.cajaObservaciones2 = function(expresion, div, mensaje, nombreCaja){
	...
	//*****************************************************************************************************************
	//** Funcion para validar que el campo contenga almenos un caracter
	//**Jes�s Neira Guio
	//** 06/07/2017 
	//*****************************************************************************************************************
	$.validator.addMethod("esAlfanumerica",function (value, element){		
	...
	//3) Funcion que me dice cual es el n�mero de dias en un mes
	...
	//6) Funcion para obtener el numero de dias en un mes dado el a�o y el mes.
	...
	function obtenerSalario(){
		...
		$.ajax({
			type: "POST",
			url: base_url + "obtenersalario/obtenerSalario",
			dataType: "json",
			cache: false,

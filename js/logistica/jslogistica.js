...
$(function(){
	...
	$("#inoee").hint("Incluya todo lo referente a alquiler, log&iacute;stica, alimentaci&oacute;n, etc..");
	...
	//Valida el envï¿½o del formulario de agregar fuente
	//Valida el envï¿½o del formulario de agregar fuentes
	...
	//Abrir la ventana para obtener las observaciones de logï¿½stica para el capitulo I (Caratula)
	...
	//Abrir la ventana para obtener las observaciones de logï¿½stica para el capitulo II (Movimiento mensual)
	$("#btnOBSLogisticaII").click(function(){		
            if ($("#frmModuloII").valid()){
                if(parseInt($("#potpsfr").val())==0){
                    del=confirm('¿Está seguro que desea registrar el valor de personal propietarios, socios y familiares en 0?');
                    if(del){ 
                        cierto=1;
                    }else {
                        return false; 
	...
	//Abrir la ventana para obtener las observaciones de logï¿½stica para el capitulo III (Ingresos Netos Operacionales)
	$("#btnOBSLogisticaIII").click(function(){		
        ...
        //Abrir la ventana para obtener las observaciones de logï¿½stica para el capitulo IV (Personal ocupado promedio)
	...
	//Abrir la ventana para obtener las observaciones de logï¿½stica para el envï¿½o del formulario (Envï¿½o formulario)
...
function obtenerMensaje3(campo){
	...
	switch(campo){
		...
		case 'insr':    mensaje = "Justificar por qu&eacute; los ingresos por servicios receptivos y conexos son mayores que los ingresos por alojamiento.";
						break;
		case 'inoe':    mensaje = "Justificar por qu&eacute; los ingresos por organizaci&oacute;n de convenciones (MICE)  son mayores que los ingresos por alojamiento, y especifique los principales eventos realizados.";
						break;
		case 'inoio':    mensaje = "Justifique cual o cuales  ingresos son los  que inciden al aumento del valor de otros ingresos.";
						break;
		case 'intio3': 	mensaje = "Justifique el por qu&eacute; sus ingresos diferentes a alojamiento son proporcionalmente mayores en el total de ingresos.";
						break;
		case 'intio1':  mensaje = "Justificar el bajo porcentaje de ingresos por alojamiento en el total de ingresos.";
						break;				
	}
...
function obtenerMensaje4(campo){
	...
	switch(campo){
		...
		case 'huetot':  mensaje = "Justifique por qu&eacute; durante el mes, el n&uacute;mero total de hu&eacute;spedes es igual al n&uacute;mero de camas vendidas.";
		  				  break;                  
		case 'thudob':  mensaje = "Verificar por qu&eacute; la tarifa por persona en habitaci&oacute;n sencilla es mayor que la doble.";
						  break;
		case 'thusui':  mensaje = "Verificar por qu&eacute; la tarifa por persona en habitaci&oacute;n sencilla es mayor que la tipo suite.";
						  break;
		case 'thumult':  mensaje = "Verificar por qu&eacute; la tarifa por persona en habitaci&oacute;n sencilla es mayor que la m&uacute;ltiple.";
		  				  break;				  	
		case 'inoe':    mensaje= "Especifique el ingreso por alquiler de salones indicando los principales eventos realizados.";
						 break;
		case 'incat':   mensaje = "Especifique el ingreso por servicios de catering para eventos.";
						break;
		case 'mvam':  mensaje = "Especifique otros motivos viaje no solicitados antes, residentes.";
        				break;
		case 'mvamnr':  mensaje = "Especifique otros motivos viaje no solicitados antes, no residentes.";
						break;		
	}
	return mensaje;
}

			...
			for (j=0; j<categoriasChecked.length; j++){ //Recorrer el array que contiene las categorias que fueron seleccionadas
				switch(categoriasChecked[j]){
					...
					case 2: nombreCategoria = "Aparta - Hoteles";
						    arrayServicios = ["chkServicios21","chkServicios22","chkServicios23","chkServicios24","chkServicios25","chkServicios26","chkServicios27","chkServicios28","chkServicios29","chkServicios210","chkServicios211","chkServicios212","chkServicios213","chkServicios214","chkServicios215"];
						    break;
